...
public:
    ...
    std::vector<std::pair<std::string, std::string>>& inputParams() { return input_params_; }
    std::vector<std::pair<std::string, std::string>>& outputParams() { return output_params_; }
